...
{
    public class PaymentDataSearchIndex : AbstractIndexCreationTask<Payment, PaymentDataSearchIndex.Result>
    {
        public PaymentDataSearchIndex()
        {
            ...
            //Index(x => x.ContentsForSearch, FieldIndexing.Search);
        }
