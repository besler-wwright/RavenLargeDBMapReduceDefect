...
namespace RavenDBTestApril2019
{
    ...
    //taken from  https://designingefficientsoftware.wordpress.com/
    ...
    unsafe public class WinFileIO : IDisposable
    {
        ...
        public int Write(int BytesToWrite)
        {
            ...
            {
                Win32Exception WE = new Win32Exception();
                ApplicationException AE = new ApplicationException("WinFileIO:Write - Error occurred writing a file. - " + WE.Message);
                throw AE;
            }
